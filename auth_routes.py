    ...
    try:
        ...
        if user:
            ...
            try:
                ...
                track('signup', source='google', user_id=user.id)
            except Exception:
                pass
...
def auth_register():
    ...
    try:
        from funnel_tracker import track
        track('signup', source='email', user_id=user.id)
    except Exception:
        pass
...
def auth_forgot_password():
    ...
    if user:
        ...
        reset_url = url_for('auth_reset_password_page', token=link.token, _external=True)
