...
class CrossReferenceEngine:
    ...
    def cross_reference(
        ...
        # FIXED: Check ALL severities, not just CRITICAL/MAJOR
        # Even minor issues should be disclosed for transparency
        for finding in inspection_doc.inspection_findings:
            # REMOVED severity filter - check all findings
            ...
            if not matching_disclosures:
                # Inspector found issue with no related disclosure
                undisclosed.append(CrossReferenceMatch(
                    disclosure_item=None,
                    inspection_finding=finding,
                    match_type="undisclosed",
