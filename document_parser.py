...
class DocumentParser:
    ...
    def _extract_problems(self, text: str) -> List[InspectionFinding]:
        ...
        # Split into sentences (better than splitting by lines)
        ...
        for sentence in sentences:
            ...
            if self._indicates_problem(sentence):
                problem = self._create_finding_from_sentence(sentence)
                if problem:
    ...
    def _create_finding_from_sentence(self, sentence: str) -> Optional[InspectionFinding]:
