...
class NegotiationToolkit:
    ...
    def generate_offer_justification_letter(
        ...
        # Get risk tier
        risk_tier = risk_score.get('risk_tier', 'MODERATE')
        offer_score = risk_score.get('overall_risk_score', 50)
        
        sections.append(f"Property Risk Assessment: {risk_tier} ({offer_score:.0f}/100)")
        sections.append("")
