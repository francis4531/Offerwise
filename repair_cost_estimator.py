...
BASELINE_COSTS = {
    # Ranges tightened to ~1.4-1.6x spread (vs old 3-5x).
    # Midpoint matches RSMeans 2026 national average; low=10th pctile, high=90th pctile.
    # Sources: RSMeans Residential Repair 2026, HomeAdvisor True Cost Guide, HomeGuide 2026.
    'foundation': {
        'minor':    (800,    1_400),
        'moderate': (4_500,  7_000),
        'major':    (12_000, 19_000),
        'critical': (28_000, 45_000),
    },
    'roof': {
        'minor':    (500,    900),
        'moderate': (2_800,  4_500),
        'major':    (8_000,  12_500),
        'critical': (14_000, 22_000),
    },
    'hvac': {
        'minor':    (350,    600),
        'moderate': (1_400,  2_400),
        'major':    (4_500,  7_000),
        'critical': (9_000,  14_000),
    },
    'plumbing': {
        'minor':    (400,    700),
        'moderate': (2_000,  3_500),
        'major':    (6_000,  10_000),
        'critical': (14_000, 22_000),
    },
    'electrical': {
        'minor':    (350,    600),
        'moderate': (1_300,  2_200),
        'major':    (3_500,  6_000),
        'critical': (9_000,  15_000),
    },
    'water_damage': {
        'minor':    (800,    1_400),
        'moderate': (2_500,  4_500),
        'major':    (6_000,  10_500),
        'critical': (14_000, 24_000),
    },
    'pest': {
        'minor':    (350,    600),
        'moderate': (900,    1_600),
        'major':    (3_200,  5_500),
        'critical': (8_000,  14_000),
    },
    'environmental': {
        'minor':    (500,    900),
        'moderate': (2_000,  3_500),
        'major':    (6_000,  10_000),
        'critical': (12_000, 20_000),
    },
    'permits': {
        'minor':    (900,    1_500),
        'moderate': (3_500,  6_000),
        'major':    (8_000,  14_000),
        'critical': (16_000, 28_000),
    },
    'safety': {
        'minor':    (350,    600),
        'moderate': (1_300,  2_200),
        'major':    (3_500,  6_000),
        'critical': (7_000,  12_000),
    },
    'general': {
        'minor':    (500,    900),
        'moderate': (2_200,  3_800),
        'major':    (5_500,  9_500),
        'critical': (11_000, 19_000),
    },
}
